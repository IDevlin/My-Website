  ...
  return function (e, i) {
        ...
        t.dragging || Y(i, 'onDragStart', I)(x()),
          ...
          (t.move = function (e) {
            var t,
              ...
              r = a[this.b];
            this.dragging &&
              ((t = M(e) - this.start + (this._b - this.dragOffset)),
              1 < z && (t = Math.round(t / z) * z),
              t <= n.minSize + y + this._b
                ? (t = n.minSize + this._b)
                : t >= this.size - (r.minSize + y + this._c) &&
    ...
    function B(n, r) {
      A.forEach(function (t) {
        if (
          (!0 !== r
            ? t.parent.removeChild(t.gutter)
            : (t.gutter[R]('mousedown', t._a), t.gutter[R]('touchstart', t._a)),
          !0 !== n)
        ) {
    ...
    return (
      (a = l.map(function (e, t) {
        var n,
          r,
          i,
          s = { element: X(e), size: m[t], minSize: d[t], i: t };
        if (
          0 < t &&
          (((n = { a: t - 1, b: t, dragging: !1, direction: S, parent: c })._b =
            G(v, t - 1 == 0, !1, p)),
        ...
        return (
          k(s.element, s.size, G(v, 0 === t, t === l.length - 1, p), t),
          0 < t && A.push(n),
          s
        );
      })).forEach(function (e) {
